export default function PremiumCannabisDomainsLandingPage() {
  const domains = [
    {
    ...
    },
    {
      name: '007Labs.com',
      label: 'PREMIUM DOMAIN',
      hook: 'Fast, memorable shorthand for a lab-led brand with covert cool built in',
      tags: ['Labs', 'Memorable', 'Cool'],
    },
    {
